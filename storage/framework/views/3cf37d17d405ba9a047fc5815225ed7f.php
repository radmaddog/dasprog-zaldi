        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('water_usages.create')); ?>">Input Data</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('water_usages.index')); ?>">Lihat Data</a>
                    </li>
                    <li class="nav-item">
...
<?php /**PATH C:\laragon\www\pdam-online\resources\views/layout.blade.php ENDPATH**/ ?>