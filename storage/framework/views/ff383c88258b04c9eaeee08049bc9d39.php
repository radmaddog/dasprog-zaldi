...
<div class="card">
    ...
    <div class="card-body">
        <form action="<?php echo e(route('water_usages.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
                ...
                <select name="category" id="category" class="form-control" required>
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($category->id); ?>" 
                                data-rate-0-10="<?php echo e($category->rate_0_10); ?>" 
                                data-rate-11-20="<?php echo e($category->rate_11_20); ?>" 
                                data-rate-21-plus="<?php echo e($category->rate_21_plus); ?>">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pdam-online\resources\views/water_usages/create.blade.php ENDPATH**/ ?>